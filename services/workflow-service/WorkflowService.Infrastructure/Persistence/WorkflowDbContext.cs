...
public sealed class WorkflowDbContext : DbContext
{
        ...
        ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<WorkflowInstance>(e =>
        {
            ...
            e.Property(x => x.CurrentStageOrder)
                .HasColumnName("current_stage_order");
            e.Property(x => x.InitiatedByUserId)
        ...
        modelBuilder.Entity<WorkflowStage>(e =>
        {
            ...
            e.HasKey(x => x.Id);
            e.Property(x => x.Id).HasColumnName("id");
            e.Property(x => x.WorkflowInstanceId)
                .HasColumnName("workflow_instance_id");
            e.Property(x => x.StageOrder)
                .HasColumnName("stage_order");
            e.Property(x => x.StageName)
                .HasColumnName("stage_name")
                .HasMaxLength(100);
            e.Property(x => x.AssignedToUserId)
                .HasColumnName("assigned_to_user_id");
            e.Property(x => x.AssignedToEmail)
